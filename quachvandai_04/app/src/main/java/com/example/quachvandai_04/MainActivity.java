...
public class MainActivity extends AppCompatActivity {
    ...
    final String DATABASE_NAME = "hoadonkhachsan.sqlite";
    ...
    private void readData(){
        this.sqlData = database.initDatabase(this, DATABASE_NAME);
    ...
    public void sort_SoPhong(String orderBy){
        ...
        Cursor cursor = this.sqlData.query("hoadon_2409",
    ...
    private void addEvents(){
        ...
        SQLiteDatabase database2 = database.initDatabase(this,DATABASE_NAME );
                ...
                if(index!=-1) {
                    ...
                    builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            hoadon_2409 hd = lsthoadon.get(index);
                            database2.delete("hoadon_2409", "ma = ?", new String[]{hd.getMa() + ""});
                            index = -1;
                            Cursor cursor = sqlData.rawQuery("SELECT * FROM hoadon_2409",null);
                            HienDuLieu(cursor);
                        }
        ...
        lstview.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String searchQuery = "SELECT * FROM hoadon_2409 " +
    ...
    public void Search(String query) {
        SQLiteDatabase database1 = database.initDatabase(this, DATABASE_NAME);
        String searchQuery = "SELECT * FROM hoadon_2409 WHERE (dongia) >=('" + query+ "'/songayluutru)";
